  ...
  <el-row>
    <el-col :span="8">
      <el-card class="box-card">
        ...
        <el-form ref="form" :model="company" :rules="rules" label-width="70px">
    ...
    <el-col :span="16">
      <el-card class="box-card">
        <div slot="header">
          <span class="titleFont">公司名称 </span>
          <el-input v-model="searchWord" class="search"></el-input>
          <el-button @click="search">搜索</el-button>
        </div>
        <el-table border :data="companyData"
  ...
  methods: {
    ...
    lookup: function () {
      ...
      _this.$http.get('/company/lookup', {
        ...
        _this.companyData = data.companys
      })
    },
    addNew: function () {
      let _this = this
      _this.$http.post('/company/create', _this.company).then(res => {
        if (res.data.success) {
          _this.$message({
            showClose: true,
            message: '公司创建成功',
