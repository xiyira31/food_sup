<template>
  <div>
    <table class="orderTable myDivToPrint" v-if="orderStyle === 1">
      <tr>
    ...
    <table class="orderTable myDivToPrint" v-if="orderStyle === 2">
      <tr>
        <th colspan="6">{{company? company.name : ''}}配送单</th>
      </tr>
      <tr class="secondLine">
    ...
    <table class="orderTable myDivToPrint" v-if="orderStyle === 8">
      <tr>
        <th colspan="6">{{company? company.name : ''}}配送单</th>
      </tr>
      <tr class="secondLine">
    ...
    <table class="orderTable myDivToPrint1" v-if="orderStyle === 3">
      <tr>
        <th colspan="6">{{company? company.name : ''}}配送单</th>
      </tr>
      <tr class="secondLine">
      ...
      <tr v-for="i in 20 - details.length" class="borderCell" :key="i">
        <td>
        </td>
        <td>
        </td>
    ...
    <table class="orderTable3 myDivToPrint" v-if="orderStyle === 4">
      <tr>
        <th colspan="8">{{company? company.name : ''}}配送单</th>
      </tr>
      <tr class="secondLine">
      ...
      <tr v-for="detail in details" class="borderCell" :key="detail.id">
        ...
        <td>
          {{detail._product.spec}}
        </td>
        <td>
          {{detail.produce_date}}
        </td>
        <td>
          {{detail._product.shelf_life}}
        </td>
        <td>
          {{handleNum(detail)}}
        </td>
    ...
    <table class="orderTable2 myDivToPrint3" v-if="orderStyle === 5">
      <tr>
        <th colspan="9">{{company? company.name : ''}}配送单</th>
      </tr>
      <tr class="secondLine">
        <td colspan="5" style="text-align:left">
          收货单位：{{school ? school.name : ''}}
      ...
      <tr v-for="i in 14 - details.length" class="borderCell" :key="i">
        <td>
        </td>
        <td>
        </td>
    ...
    <table class="orderTable myDivToPrint" v-if="orderStyle === 6">
      <tr>
        <th colspan="6">{{company? company.name : ''}}配送单</th>
      </tr>
      <tr class="secondLine">
    ...
    <table class="orderTable4 myDivToPrint1" v-if="orderStyle === 7">
      <tr>
        <th colspan="6">{{company? company.name : ''}}配送单</th>
      </tr>
      <tr class="secondLine">
    ...
    <table class="orderTable myDivToPrint" v-if="orderStyle === 9">
      <tr>
        <th colspan="6">{{company? company.name : ''}}配送单</th>
      </tr>
      <tr class="secondLine">
    ...
    <table class="orderTable myDivToPrint" v-if="orderStyle === 10">
      <tr>
        <th colspan="6">{{company? company.name : ''}}配送单</th>
      </tr>
      <tr class="secondLine">
